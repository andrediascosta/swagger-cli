 ...
 * @param {{outfile: string, dereference: boolean, format: number, wrap: number}} options - Options
...
module.exports = async function bundle (api, options) {
  ...
  let opts = {
    dereference: {
      circular: options.dereference || (options.dereference && "ignore")
    }
  };
 ...
 * @param {string|number} spaces - Spaces
 */
